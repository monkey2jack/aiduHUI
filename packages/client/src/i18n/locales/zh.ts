...
export default {
  ...
  browser: {
    title: '浏览器', settings: '浏览器设置', desktopOnly: '内置浏览器仅在 aiduHUI 桌面端可用。', newTab: '新标签页',
  ...
  agentManager: {
    ...
    legacyDataMigrationDescription: 'aiduHUI 在旧版 Windows 数据目录中发现了数据。是否将其迁移到当前数据目录？',
    ...
    legacyDataMigrationSuccess: '已记录迁移选择，aiduHUI 将重启并在服务启动前迁移数据。',
  ...
  runtimeVersions: {
    ...
    dataDirectoryEnvRestart: '修改后请完全退出并重新打开 aiduHUI。若 Windows 或 Linux 桌面端仍读取旧值，请注销并重新登录系统。',
    cliUpdateDescription: 'Hermes Runtime 0.19.1 及以上版本支持通过以下命令单独升级内置的 Hermes Agent；该命令不会升级 aiduHUI 桌面端或 Web UI。执行前请先完全退出 aiduHUI：',
    webUiTitle: 'Web UI',
    platform: '平台',
    ...
    runtimeDirectorySaved: 'Runtime 迁移已安排，重启 aiduHUI 后执行。',
    runtimeMigrationPending: '待迁移到：{directory}',
    runtimeMigrationFailed: '存储目录迁移失败，已继续使用原目录',
    runtimeActivationFailed: '所选 Runtime 无法启动，aiduHUI 已改用其他已安装版本',
    active: '已启用',
    installed: '已安装',
    download: '下载',
    ...
    activateSuccess: '版本选择已保存，重启 aiduHUI 后生效。',
  ...
  connections: {
    ...
    app: {
      ...
      viewDownload: '下载',
      viewMessages: '消息推送',
      downloadTitle: '在手机上使用 aiduHUI',
      downloadDescription: '我们正在内测阶段，需要注册码才有办法注册，我们会在社交媒体放出一部分注册码。',
      downloadPaidDescription: 'aiduHUI App 已正式上线，目前处于付费阶段。如需体验，请前往定价与购买页面选择合适的方案，完成购买后即可开始使用。',
      downloadScan: '手机扫码下载',
      ...
      accessFailures: {
        ...
        cloudSubscriptionRequired: '当前账号未开通 aiduHUI Cloud，无法使用云端连接',
  ...
  chat: {
    ...
    pushEnabled: '是否推送',
    pushNotConfigured: '请先到 aiduHUI「设备互联」中配置消息推送。',
  ...
  settings: {
    ...
    display: {
      ...
      notifyOnApprovalHint: 'aiduHUI 不在前台时，出现新的审批或澄清会发送系统通知；通知不显示敏感详情',
      ...
      approvalNotificationBody: '打开 aiduHUI 查看并处理。',
    ...
    voice: {
      ...
      hermesConfigDescription: 'Hermes profile 中原有的原生提供商会继续保留；Web UI 管理的提供商对 Hermes 统一显示为 aiduHUI。',
  ...
  // 更新日志
  changelog: {
    new_0_7_19_1: '品牌升级为 aiduHUI，统一应用图标、官网域名、CLI 命令与产品文档 (#2966, #2980, #2981, #2992, #2994)',
  ...
  workbench: {
    navLabel: '工作台导航',
    sectionModels: '模型管理',
    sectionModelsHint: '通用 · 辅助 · 组合',
    sectionSettings: '设置',
    sectionSettingsHint: '压缩 · 性能 · 用量 · 日志',
    sectionJobs: '任务',
    sectionJobsHint: '定时与执行记录',
    sectionChannels: '频道',
    sectionChannelsHint: '平台接入',
    sectionMemory: '记忆',
    sectionMemoryHint: '长期记忆',
    paneCompression: '上下文压缩',
    panePerformance: '性能监控',
    paneUsage: '用量',
    paneLogs: '日志',
  },
}
