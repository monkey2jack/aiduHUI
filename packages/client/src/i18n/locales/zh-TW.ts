...
export default {
  ...
  browser: {
    title: '瀏覽器', settings: '瀏覽器設定', desktopOnly: '內建瀏覽器僅在 aiduHUI 桌面版可用。', newTab: '新分頁',
  ...
  agentManager: {
    ...
    legacyDataMigrationDescription: 'aiduHUI 在舊版 Windows 資料目錄中發現了資料。是否將其遷移到目前資料目錄？',
    ...
    legacyDataMigrationSuccess: '已記錄遷移選擇，aiduHUI 將重新啟動並在服務啟動前遷移資料。',
  ...
  runtimeVersions: {
    ...
    dataDirectoryEnvRestart: '修改後請完全結束並重新開啟 aiduHUI。若 Windows 或 Linux 桌面端仍讀取舊值，請登出並重新登入系統。',
    cliUpdateDescription: 'Hermes Runtime 0.19.1 及以上版本支援透過以下指令單獨升級內建的 Hermes Agent；此指令不會升級 aiduHUI 桌面端或 Web UI。執行前請先完全結束 aiduHUI：',
    webUiTitle: 'Web UI',
    platform: '平台',
    ...
    runtimeDirectorySaved: 'Runtime 遷移已排程，重新啟動 aiduHUI 後執行。',
    runtimeMigrationPending: '待遷移至：{directory}',
    runtimeMigrationFailed: '儲存目錄遷移失敗，已繼續使用原目錄',
    runtimeActivationFailed: '所選 Runtime 無法啟動，aiduHUI 已改用其他已安裝版本',
    active: '已啟用',
    installed: '已安裝',
    download: '下載',
    ...
    activateSuccess: '版本選擇已儲存，重啟 aiduHUI 後生效。',
  ...
  connections: {
    ...
    app: {
      ...
      viewDownload: '下載',
      viewMessages: '訊息推送',
      downloadTitle: '在手機上使用 aiduHUI',
      downloadDescription: '我們目前正處於封閉測試階段，必須使用註冊碼才能註冊；我們會在社群媒體上釋出部分註冊碼。',
      downloadPaidDescription: 'aiduHUI App 已正式上線，目前處於付費階段。如需體驗，請前往定價與購買頁面選擇合適的方案，完成購買後即可開始使用。',
      ...
      accessFailures: {
        ...
        cloudSubscriptionRequired: '目前帳號尚未開通 aiduHUI Cloud，無法使用雲端連線',
  ...
  chat: {
    ...
    pushEnabled: '是否推送',
    pushNotConfigured: '請先到 aiduHUI「裝置互聯」中設定訊息推送。',
  ...
  settings: {
    ...
    display: {
      ...
      notifyOnApprovalHint: 'aiduHUI 不在前景時，新的審批或澄清會傳送系統通知；通知不顯示敏感詳情',
      ...
      approvalNotificationBody: '開啟 aiduHUI 查看並處理。',
    ...
    voice: {
      ...
      hermesConfigDescription: 'Hermes profile 中原有的原生提供商會繼續保留；Web UI 管理的提供商對 Hermes 統一顯示為 aiduHUI。',
      ...
      useHermesStudioProvider: '使用 aiduHUI 提供商',
  ...
  // 更新日誌
  changelog: {
    new_0_7_19_1: '品牌升級為 aiduHUI，統一應用程式圖示、官網網域、CLI 指令與產品文件 (#2966, #2980, #2981, #2992, #2994)',
  ...
  workbench: {
    navLabel: '工作台導覽',
    sectionModels: '模型管理',
    sectionModelsHint: '通用 · 輔助 · 組合',
    sectionSettings: '設定',
    sectionSettingsHint: '壓縮 · 效能 · 用量 · 日誌',
    sectionJobs: '任務',
    sectionJobsHint: '定時與執行紀錄',
    sectionChannels: '頻道',
    sectionChannelsHint: '平台接入',
    sectionMemory: '記憶',
    sectionMemoryHint: '長期記憶',
    paneCompression: '上下文壓縮',
    panePerformance: '效能監控',
    paneUsage: '用量',
    paneLogs: '日誌',
  },
}
