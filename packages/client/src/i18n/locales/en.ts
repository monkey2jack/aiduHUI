...
export default {
  ...
  browser: {
    title: 'Browser', settings: 'Browser Settings', desktopOnly: 'The embedded browser is available only in aiduHUI Desktop.', newTab: 'New Tab',
  ...
  agentManager: {
    ...
    path: 'Path',
    userCli: 'Hermes CLI',
    userCliReadonly: 'aiduHUI checks the current environment for a CLI first; CLI installations remain user managed.',
    readOnly: 'Read only',
    ...
    legacyDataMigrationDescription: 'aiduHUI found data in a legacy Windows data directory. Would you like to migrate it to the current data directory?',
    ...
    legacyDataMigrationSuccess: 'Migration scheduled. aiduHUI will restart and migrate the data before starting local services.',
  ...
  runtimeVersions: {
    ...
    dataDirectoryEnvRestart: 'Fully quit and reopen aiduHUI after changing it. On Windows or Linux, sign out and back in if the desktop app still sees the old value.',
    cliUpdateDescription: 'Hermes Runtime 0.19.1 and later can use the following command to update the bundled Hermes Agent only. It does not update the aiduHUI desktop app or Web UI. Fully quit aiduHUI before running:',
    webUiTitle: 'Web UI',
    platform: 'Platform',
    ...
    runtimeDirectorySaved: 'Runtime migration scheduled. Restart aiduHUI to apply it.',
    ...
    runtimeActivationFailed: 'The selected Runtime could not start, so aiduHUI used another installed version',
    active: 'Active',
    installed: 'Installed',
    download: 'Download',
    ...
    activateSuccess: 'Version selection saved. Restart aiduHUI to use it.',
  ...
  connections: {
    ...
    app: {
      ...
      downloadTitle: 'aiduHUI on your phone',
      ...
      downloadPaidDescription: 'The aiduHUI App is now officially available as a paid product. To get started, visit the pricing and purchase page, choose the plan that suits you, and complete your purchase.',
      ...
      accessFailures: {
        ...
        cloudSubscriptionRequired: 'This account does not have aiduHUI Cloud access',
  ...
  chat: {
    ...
    pushNotConfigured: 'Configure Message Push in aiduHUI “Device Connections” before enabling it.',
  ...
  settings: {
    ...
    voice: {
      ...
      hermesConfigDescription: 'Existing native providers remain in the Hermes profile. Web UI providers appear to Hermes as aiduHUI.',
      ...
      useHermesStudioProvider: 'Use aiduHUI provider',
  ...
  // Changelog
  changelog: {
    new_0_7_19_1: 'Rebranded as aiduHUI with unified app icons, website domains, CLI commands, and product documentation (#2966, #2980, #2981, #2992, #2994)',
  ...
  workbench: {
    ...
    sectionModelsHint: 'General · Auxiliary · Combination',
    sectionSettings: 'Settings',
    sectionSettingsHint: 'Compression · Performance · Usage · Logs',
    sectionJobs: 'Jobs',
    sectionJobsHint: 'Schedules and run history',
    sectionChannels: 'Channels',
    sectionChannelsHint: 'Platform integrations',
    sectionMemory: 'Memory',
    sectionMemoryHint: 'Long-term memory',
    paneCompression: 'Context compression',
